...
//Authorized the author who have been logged in succesfully----
...
const authorization = async (req, res, next) => {
    try {
        ...
        //if authorId is not present in request body or request params
         if (!authorLogging) {
...
//For deletion of the blogs by the author who has been authorized to do it...
